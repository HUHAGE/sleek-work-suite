...
import { Type, Settings, Archive, FileCode, ChevronLeft, Globe, Shield, Download, PlayCircle, Database, FileJson, KeyRound, Key, Brain, FileText } from 'lucide-react';
...
import CozeApiDocGenerator from '@/components/tools/CozeApiDocGenerator';
...
const Index = () => {
  ...
  const tools: Tool[] = [
    ...
    { id: 'coze-api-doc', name: 'Coze接口文档生成', dec: '上传单个接口代码文件，使用Coze AI生成专业的接口文档', icon: FileText, component: CozeApiDocGenerator },
    { id: 'api-doc', name: 'DeepSeek接口文档生成', dec: '根据代码生成专业的接口文档，支持多种格式导出（实验性功能，请谨慎使用）', icon: FileJson, component: ApiDocGenerator },
